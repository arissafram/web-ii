...
## Camp 
Interactive Web Apps & Games </br>
https://www.kingswoodoxford.org/camp-ko/arts-and-academic-camps/

## Games

- **Mystery button** - Clicking a button makes the button change size, color, etc.
- **Race car game** - Keydown races the cars across a screen
- **Rock paper scissors** - RPS against the computer without prompts
- **Tic tac toe** - Tic tac toe but without any win logic (which is not at all fun?)
- **Matching game** - Standard matching game with data attributes comparison, no look ups
- **Click the ball** - CSS / JS whack-a-mole like game
